...
<html>
  <head>
    <meta charset="UTF-8">
    <title>PT. Bonanza Travel Ilham Makmur</title>
    <meta content='width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no' name='viewport'>
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    <meta name="description" content="Bonanza Travel Ilham Makmur">
    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="?module=beranda" class="logo">
          <img style="margin-top:-1px;margin-right:5px" src="assets/img/bonanza.png" alt="Logo" height="50"> 
          <span style="font-size:20px">Bonanza Travel</span>
        </a>
